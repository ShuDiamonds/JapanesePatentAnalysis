...
if __name__ == '__main__':
    ...
    result_list=[]
    with open("./janome_extracted.txt", mode='r') as f:
    ...
    #saving
    allText = '\n'.join(result_list)
    with open("converted_pre-dic.csv", mode='w') as f:
        f.write(allText)
    
    
    os.system('/usr/lib/mecab/mecab-dict-index -d /usr/lib/mecab/dic/mecab-ipadic-neologd/ -u patentdic.dic -f utf-8 -t utf-8 converted_pre-dic.csv')
